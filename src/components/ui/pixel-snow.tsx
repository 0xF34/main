...
/**
 * PixelSnow — React Bits component.
 * Renders a three.js shader-based pixelated snow/particle field.
 *
 * Source: https://reactbits.dev
 * Background stays transparent so the BLACK page shows through.
 */
...
export default function PixelSnow({
  ...
  useEffect(() => {
    ...
    // Keep clear color transparent so the BLACK page background shows through.
