...
/**
 * FuzzyText — React Bits component.
 * Renders text on a canvas with a per-frame horizontal/vertical fuzz displacement.
 *
 * Source: https://reactbits.dev (MIT-style, free to use).
 * Integrated unchanged except for: default color forced to pure white so it
 * always reads on the BLACK background this site uses.
 */
